        ...
        <div class="container">
            <div class="image-section">
                <div class="row">    
                    <div class="col-lg-6">
                        <div class="image-1">
                            <img src="{{ asset('assets/images/about/img-1.jpg') }}" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="image-2">
                            <img src="{{ asset('assets/images/about/img-2.jpg') }}" alt="img">
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper rts-cmmnSlider-over2" data-swiper="pagination">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="team-wraper">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('assets/images/about/1.jpg') }}" alt="collection-image"></a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="team-wraper">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('assets/images/about/2.jpg') }}" alt="collection-image"></a>
                                </div>
                                <div class="team-content">
                                    <h3>
                        ...
                        <div class="swiper-slide">
                            <div class="team-wraper">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('assets/images/about/3.jpg') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="team-wraper">
                                <div class="team-thumb">
                                    <a href="#"><img src="{{ asset('assets/images/about/4.jpg') }}" alt="collection-image"></a>
                                </div>
                                <div class="team-content">
                                    <h3>
        ...
        <div class="container">
            <div class="features-1">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="image-section">
                            <a href="#"><img src="{{ asset('assets/images/about/features-1.jpg') }}" alt="features-1"></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="features-2">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="image-section">
                            <a href="#"><img src="{{ asset('assets/images/about/features-2.jpg') }}" alt="#"></a>
                        </div>
                    </div>
                </div>
            </div>
